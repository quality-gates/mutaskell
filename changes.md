...
## [0.8.17]
  ...
  * Added: `bench/mutation.sh` and `bench/mutation-bench.hs`, which measure selector work separately from cap-1 sampled rendering on typed-declaration-heavy and nested-subtree fixtures without attributing an end-to-end speedup absent a printing profile.
